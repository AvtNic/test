...
from new_pr.db import get_cities, create_table, add_cities, save_user, get_user_with_cities
...
#     for user in users:
#         bot.send_message(message.chat.id, f"{user[0]} - {user[1]} - {user[2]}"
#         #построчный вывод в тг
